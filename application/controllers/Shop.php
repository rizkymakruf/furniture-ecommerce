...
class Shop extends MY_Controller
{
    ...
    public function search($page = null)
    {
        ...
        if ($this->shop->like('product.title', $keyword)->count() < 1) {
            $data['flash']      = $this->session->set_flashdata('error', 'Product tidak ditemukan!');
            $data['page']       = 'pages/home/index';

            $this->view($data);
        } else {
            $data['flash']      = $this->session->set_flashdata('success', 'Product terkait ditemukan!');
            $data['page']       = 'pages/home/index';
