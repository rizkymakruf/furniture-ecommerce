...
class Product extends MY_Controller
{
    ...
    public function index($page = null)
    {
        ...
        $data['content']        = $this->product->select(
            [
                ...
                'product.price', 'product.is_available', 'product.weight', 'product.production_cost',
    ...
    public function unique_title()
    {
        ...
        $product        = $this->product->where('title', $title)->first();
        ...
        if ($product) {
            ...
            $this->form_validation->set_message('unique_title', '%s sudah digunakan!');
            return false;
        }
    ...
    public function print($page = null)
    {
        $data['title']          = 'Print Produk';
        $data['content']        = $this->product->select(
            [
                'product.id', 'product.title AS product_title', 'product.image',
                'product.price', 'product.is_available', 'product.weight', 'product.production_cost',
